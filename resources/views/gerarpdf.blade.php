...
<p>Total de Receita: <span  class="text-success"><?php echo 'R$ ' . number_format($somar, 2, ',', '.'); ?></span></p>
<p>Total de Despesas: <span class="text-danger"><?php echo '-R$ ' . number_format($somad, 2, ',', '.'); ?></span></p>
<p>Total de Sombra: <span class="text-primary"><?php
    $sobra = $somar - $somad;
